...
int valid_board(int **board, int size)
{
    ...
    // row checker, checks each row for duplicates
    // returns 0 if duplicates found
    ...
    // column checker, checks each column for duplciates
    // returns 0 if duplicates found
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < size; i++)
    {
        ...
        for (int j = 0; j < size; j++)
        {
            ...
            /* ADD ARRAY ACCESS CODE HERE */ *(*(arr + i) + j) = atoi(token);
